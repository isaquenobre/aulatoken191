...
public class LoginController {
  ...
  public Sessao logar(@RequestBody Login login) {
    ...
    if (user != null) {
      ...
      if (!passwordOk) {
        throw new RuntimeException("Senha inválida para o login: " + login.getUsername());// dessa linha para cima ate
                                                                                          // postMapping eu poderia ter
                                                                                          // feito um service para
                                                                                          // separar a regra de negocio
                                                                                          // do controller, mas como é
                                                                                          // um projeto pequeno, não
                                                                                          // fiz.
      }
